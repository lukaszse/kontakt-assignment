...
import static io.kontakt.apps.temperature.generator.publisher.TemperaturePublisherTestData.isBetween
import static io.kontakt.apps.temperature.generator.temperaturegenerator.SimpleTemperatureGenerator.CONSTANT_CHARACTERISTIC
...
import static io.kontakt.apps.temperature.generator.temperaturegenerator.TemperatureGeneratorTestData.prepareHarmonicTempGenerator
...
class SimpleTemperatureGeneratorTest extends Specification {
    ...
    def "should generate series of single reading"() {
        ...
        HARMONIC_CHARACTERISTIC | 1.0               | 50           | 42  | 58
    ...
    def "should generate reading for all rooms"() {
        ...
        HARMONIC_CHARACTERISTIC | 1.0               | 50           | 42  | 58  | 3             | 3
