package io.kontakt.apps.anomaly.detector.listener;

import io.kontakt.apps.anomaly.detector.detector.AnomalyDetector;
...
class TemperatureMeasurementsListener implements Function<KStream<String, TemperatureReading>, KStream<String, Anomaly>> {
